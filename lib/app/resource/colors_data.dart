...
class ColorsCustom {
  ...
  static const LinearGradient linearGradientWebinar = LinearGradient(
      colors: [Color(0XFFD0F1F4), Color(0xffF8F9FA)],
...
class PrimaryColor {
  ...
  Color get midOrange => const Color(0xffF1B808);
  Color get yellow => const Color(0xffFFC40C);
  Color get green => const Color(0xff50C346);
...
class OthersColor {
  ...
  // Green
  Color get green60 => const Color(0xff075E54);
